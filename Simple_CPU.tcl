...
#
# Simple_CPU.tcl: Tcl script for re-creating project 'Simple_CPU'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/design/ALU.vhd"]"\
 "[file normalize "$origin_dir/src/design/Instr_Memory.vhd"]"\
 "[file normalize "$origin_dir/src/design/Main_Register.vhd"]"\
 "[file normalize "$origin_dir/src/design/Memory.vhd"]"\
 "[file normalize "$origin_dir/src/design/Program_Counter.vhd"]"\
 "[file normalize "$origin_dir/src/design/Control_Block.vhd"]"\
...
set _xil_proj_name_ "Simple_CPU"
...
set script_file "Simple_CPU.tcl"
...
set file "$origin_dir/src/design/ALU.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Instr_Memory.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Main_Register.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Memory.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Program_Counter.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Control_Block.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
